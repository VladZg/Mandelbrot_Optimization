...
inline void SetPixels(Uint8* pixels, __m256 X0, __m256 Y0, int xi, int yi);
...
inline void MandelbrotCalc(Uint8* pixels)
{
    ...
    __m256 xShift = _mm256_mul_ps(_mm256_set1_ps(dx), Dx_coeffs);
